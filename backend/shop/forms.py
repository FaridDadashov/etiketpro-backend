...
class ContactForm(forms.ModelForm):
    class Meta:
        ...
        model=Contact
        widgets={
            'name':forms.TextInput(attrs={'class': 'form-control mb-4','placeholder':'Adiniz'}),
            'email':forms.EmailInput(attrs={'class': 'form-control mb-4','placeholder':'Emailiniz'}),
            'subject':forms.TextInput(attrs={'class': 'form-control mb-4','placeholder':'mesaj'}),
            'text':forms.Textarea(attrs={'class': 'form-control mb-4','placeholder':'Mesaj','rows':'8'}),
        }
